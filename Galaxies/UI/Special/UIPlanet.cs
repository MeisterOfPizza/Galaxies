...
namespace Galaxies.UI.Special
{
    ...
    class UIPlanet : UIGroup
    {
        ...
        public UIPlanet(Texture2D sprite, Vector2 position, EventArg onClick, Screen screen, Planet planet) : base(sprite, position, 0, Color.White, new Vector2(300, 200), onClick, screen)
        {
